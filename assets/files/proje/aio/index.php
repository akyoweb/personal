...
<html lang="en">
    <head>
        ...
        <meta name="description" content="akyo tracker" />
        <meta name="author" content="akyo" />
        <title>Akyo Tracker</title>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="sb-sidenav-footer">
                        <div class="small">Logged:akyo</div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Akyo Tracker 2026</div>
                            <div>
    ...
    function myMap() {
        ...
        marker.setMap(map);
            ...
            google.maps.event.addListener(marker, 'click', function () {
                var markerContent = '<button> click </button> akyo <br><br> توضیحات دلخواه';
